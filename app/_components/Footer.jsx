...
function Footer() {
  ...
  <div className="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
    <div className="lg:flex lg:items-start lg:gap-8 justify-center text-center flex">
        <Image src='/logo.svg'
        alt='logo'
        width={200}
        height={200}
          ...
          <form className="w-full">
            ...
            >
              <input
                type="email"
                id="UserEmail"
                placeholder=" limonad123123@inbox.ru"
              ...
              <button
                ...
                transition-none sm:mt-0 sm:w-auto sm:shrink-0 rounded-md"
              >
                Sign Up
              </button>
            </div>
    ...
    <div className="mt-8 border-t border-gray-100 pt-8">
      <div className="sm:flex sm:justify-between">
        <p className="text-xs text-gray-500">&copy; 4. BBPE. All rights reserved.</p>
